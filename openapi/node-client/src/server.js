...
const specPath = path.resolve(projectRoot, "../housedb-openapi.yaml");
...
const PORT = Number(process.env.HOUSEDB_CLIENT_PORT || 3030);
app.listen(PORT, () => {
  console.log(`housedb-node-client web UI: http://localhost:${PORT}`);
});
