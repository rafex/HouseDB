...
async function bootstrap() {
  ...
  el.baseUrl.value = localStorage.getItem("housedb.baseUrl") || serverUrl;
  el.bearerToken.value = localStorage.getItem("housedb.bearer") || "";
...
el.baseUrl.addEventListener("change", () => localStorage.setItem("housedb.baseUrl", el.baseUrl.value.trim()));
el.bearerToken.addEventListener("change", () => localStorage.setItem("housedb.bearer", el.bearerToken.value.trim()));
